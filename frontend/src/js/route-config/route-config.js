...
(function () {
    ...
    angular.module('evalai').config(configure);
    ...
    function configure(
            ...
            resolve: {
                challenge: function (utilities, $state, $stateParams) {
                    return new Promise(function (resolve) {
                        ...
                        parameters.url =
                            'challenges/' + $stateParams.challengeId + '/participant_team/team_detail';
            ...
            resolve: {
                challenge: function (utilities, $state, $stateParams) {
                    return new Promise(function (resolve, reject) {
                        ...
                        parameters.token = utilities.getData('userKey');
                        parameters.url =
                            'participants/participant_teams/challenges/' + $stateParams.challengeId + '/user';
                        parameters.method = 'GET';
                        parameters.data = {};
                        parameters.callback = {
                            onSuccess: function (response) {
        ...
        var challenge_phase_leaderboard = {
            ...
            url: '/leaderboard/:phaseSlug/:splitCodename', // Changed URL
            controller: 'ChallengeCtrl',
            controllerAs: 'challenge',
            templateUrl: baseUrl + '/web/challenge/leaderboard.html',
            title: 'Leaderboard',
        ...
        var challenge_phase_metric_leaderboard = {
            ...
            url: '/leaderboard/:phaseSlug/:splitCodename/:metric', // Changed URL
            controller: 'ChallengeCtrl',
            controllerAs: 'challenge',
            templateUrl: baseUrl + '/web/challenge/leaderboard.html',
            title: 'Leaderboard',
...
(function () {
    ...
    angular.module('evalai').run(runFunc);
