        ...
        vm.editprofileDialog = function(ev) {
            switch (ev.currentTarget.id) {
                ...
                case "affiliation":
                  ...
                  break;
                case "university":
                  vm.titleInput = "University";
                  vm.editid = "university";
                  break;
                case "address_street":
                  vm.titleInput = "Street Address";
                  vm.editid = "address_street";
                  break;
                case "address_city":
                  vm.titleInput = "City";
                  vm.editid = "address_city";
                  break;
                case "address_state":
                  vm.titleInput = "State";
                  vm.editid = "address_state";
                  break;
                case "address_country":
                  vm.titleInput = "Country";
                  vm.editid = "address_country";
                  break;
                case "github_url":
