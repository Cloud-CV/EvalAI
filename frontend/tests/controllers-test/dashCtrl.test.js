    ...
    describe('Unit tests for global backend calls', function () {
        ...
        beforeEach(function () {
            ...
            utilities.sendRequest = function (parameters) {
                ...
                (isPresentChallenge == true && parameters.url == 'challenges/challenge/time/present/approved/approved/published/public') ||
                ...
                (isPresentChallenge == false && parameters.url == 'challenges/challenge/time/present/approved/approved/published/public') ||
        ...
        it('get all ongoing challenges `challenges/challenge/time/present/approved/approved/published/public`', function () {
            isUserDetails = null;
        ...
        it('403 backend error on getting all ongoing challenges `challenges/challenge/time/present/approved/approved/published/public`', function () {
            isUserDetails = null;
        ...
        it('401 backend error on getting all ongoing challenges `challenges/challenge/time/present/approved/approved/published/public`', function () {
            isUserDetails = null;
            isPresentChallenge = false;
            isHostTeam = null;
            isParticipantTeam = null;
