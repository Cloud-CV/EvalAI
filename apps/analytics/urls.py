...
urlpatterns = [
    ...
    url(r'^challenge/(?P<challenge_pk>[0-9]+)/challenge_phase/(?P<challenge_phase_id>[0-9]+)/count$',
    ...
    url(r'^challenge/(?P<challenge_pk>[0-9]+)/challenge_phase/'
        r'(?P<challenge_phase_id>[0-9]+)/last_submission/(?P<submission_by>[A-Za-z_]+)$',
        views.get_last_submission_time, name='get_last_submission_time'),
    url(r'^challenge/(?P<challenge_pk>[0-9]+)/challenge_phase/'
        r'(?P<challenge_phase_id>[0-9]+)/last_submission_datetime_analysis/$',
        views.get_last_submission_datetime_analysis, name='get_last_submission_datetime_analysis'),
]
