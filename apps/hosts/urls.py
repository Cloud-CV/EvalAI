...
urlpatterns = [
    ...
    url(r'^challenge_host_teams/(?P<pk>[0-9]+)/invite$', views.email_invite_host_to_team,
        name='email_invite_host_to_team'),
    url(r'^invitation_host_team/(?P<team_hash>\w+)/(?P<email_hash>\w+)$', views.invitation_accepted,
        name="host_invitation_accepted"),
]
