...
def check_user_belongs_to_participant_team(user, participant_team_id):
...
def check_participant_team_participated_in_challenge(participant_team_id, challenge_id):
