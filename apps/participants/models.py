...
class Participant(TimeStampedModel):
    ...
    user = models.ForeignKey(User, related_name="participation", on_delete=models.DO_NOTHING)
    status = models.CharField(max_length=30, choices=STATUS_OPTIONS)
    team = models.ForeignKey(
        "ParticipantTeam", related_name="participants", null=True, on_delete=models.DO_NOTHING
    )
