...
may be None in some environments. This subclass catches ExpiringToken.DoesNotExist
explicitly so invalid tokens always result in AuthenticationFailed.
...
class ExpiringTokenAuthentication(BaseExpiringTokenAuthentication):
    ...
    def authenticate_credentials(self, key):
        """Authenticate using the token key; raise AuthenticationFailed for invalid/expired tokens."""
        try:
