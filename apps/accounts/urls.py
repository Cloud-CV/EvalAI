...
urlpatterns = [
    ...
    url(r"^user/generate_activation_link/(?P<user_email>[\w.@+-]+)/$",views.generate_activation_link,name="generate_activation_link"),
    url(r"^user/activate/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$", views.activate_user, name="activate_user"),
