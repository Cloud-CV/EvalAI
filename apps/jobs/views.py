...
def update_submission(request, challenge_pk):
    ...
    Query Parameters:
     ...
     - ``code_upload_submission_log``: Environment error after evaluation, e.g. "Failed due to attempted action being invalid" (**code upload challenge only**)
    ...
    if request.method == "PUT":
        ...
        code_upload_submission_log_content = request.data.get("code_upload_submission_log", "").encode("utf-8")
        ...
        submission.code_upload_environment_log_file.save("code_upload_submission_log.txt", ContentFile(code_upload_submission_log_content))
