...
class SubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'participant_team', 'participant_team_name', 'execution_time', 'challenge_phase',
                  ...
                  'submission_result_file', 'last_submission_timestamp_in_a_challenge_phase',
                  'last_submission_timestamp_in_a_challenge',
                  'last_submission_timestamp_by_participant_team_in_a_challenge_phase',)
