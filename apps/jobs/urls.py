...
urlpatterns = [
    ...
    url(r'challenge/(?P<challenge_id>[0-9]+)/'
        r'challenge_phase/(?P<challenge_phase_id>[0-9]+)/participant_team/(?P<participant_team_id>[0-9]+)/'
        r'get_remaining_submission/',
        views.remaining_submission, name='remaining_submission'),
