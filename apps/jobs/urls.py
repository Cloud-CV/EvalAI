...
urlpatterns = [
    ...
    re_path(
        r"^challenge_phase_split/"
        r"(?P<challenge_phase_split_id>[0-9]+)/leaderboard/$",
        views.leaderboard,
        name="leaderboard",
    ),
    re_path(
    ...
    re_path(
        r"^phase_splits/(?P<challenge_phase_split_pk>[0-9]+)/teams/"
        r"(?P<participant_team_pk>[0-9]+)/github_badge/$",
