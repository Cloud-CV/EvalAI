...
urlpatterns = [
    ...
    url(r'^challenge/(?P<challenge_pk>[0-9]+)/queue/(?P<queue_name>[\w-]+)/$',
        views.get_challenge_by_pk_using_queue_name,
        name='get_challenge_by_pk_using_queue_name'),
    url(r'^challenge/(?P<pk>[0-9]+)/$',
        views.get_challenge_by_pk, name='get_challenge_by_pk'),
    url(r'^challenge/(?P<challenge_pk>[0-9]+)/phases/queue/(?P<queue_name>[\w-]+)/$',
        views.get_challenge_phases_by_challenge_pk_using_queue_name,
        name='get_challenge_phases_by_challenge__pk_using_queue_name'),
    url(r'^phase/(?P<challenge_phase_pk>[0-9]+)/queue/(?P<queue_name>[\w-]+)/$',
        views.get_challenge_phase_by_pk_using_queue_name,
        name='get_challenge_phase_by_pk_using_queue_name'),
