...
class ChallengePhaseAdmin(ImportExportTimeStampedAdmin):
    list_display = ("phase_id", "name", "challenge", "start_date", "end_date", "test_annotation", "is_public",
                    "leaderboard_public")
...
class ChallengePhaseSplitAdmin(ImportExportTimeStampedAdmin):
    list_display = ("phase_split_id", "challenge_phase", "dataset_split", "leaderboard", "visibility")
