...
class TestStringMethods(BaseAPITestClass):
    ...
    def test_participants_urls(self):
        ...
        url = reverse_lazy('participants:get_participant_team_details', kwargs={
                           'pk': self.participant_team.pk})
        self.assertEqual(
            unicode(url), '/api/participants/participant_team/' + str(self.participant_team.pk))

        url = reverse_lazy('participants:invite_participant_to_team', kwargs={
                           'pk': self.participant_team.pk})
        self.assertEqual(unicode(url), '/api/participants/participant_team/' +
        ...
        self.assertEqual(unicode(url), '/api/participants/participant_team/' + str(
            self.participant_team.pk) + '/participant/' + str(self.invite_user.pk))
        ...
        self.assertEqual(
            unicode(url), '/api/participants/remove_self_from_participant_team/' + str(self.participant_team.pk))
