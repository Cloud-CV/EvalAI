...
class TestChallengeUrls(BaseAPITestClass):
    def test_challenges_urls(self):
        ...
        self.assertEqual(
            url,
            "/api/challenges/challenge_host_team/"
        ...
        self.assertEqual(
            url,
            "/api/challenges/challenge/" + str(self.challenge.pk) + "/disable",
        )
        ...
        self.assertEqual(
            ...
            "/api/challenges/{}/phase/{}/{}/download_all_submissions/{}/".format(
                self.challenge.pk, self.challenge_phase.pk, self.file_type, self.version
            ),
        )
        ...
        self.assertEqual(
            self.url, "/api/challenges/challenge/create/leaderboard/step_2/"
        )
        resolver = resolve(self.url)
        ...
        self.assertEqual(
            self.url,
            "/api/challenges/challenge/create/leaderboard/{}/".format(
                self.leaderboard.pk
            ),
        )
        resolver = resolve(self.url)
        ...
        self.assertEqual(
            self.url, "/api/challenges/challenge/create/dataset_split/step_4/"
        )
        resolver = resolve(self.url)
        ...
        self.assertEqual(
            self.url,
            "/api/challenges/challenge/create/dataset_split/{}/".format(
                self.dataset_split.pk
            ),
        )
        resolver = resolve(self.url)
        self.assertEqual(
        ...
        self.assertEqual(
            self.url,
            "/api/challenges/challenge/create/challenge_phase_split/{}/".format(
        ...
        self.assertEqual(
            self.url, "/api/challenges/{}/".format(self.challenge.pk)
        )
        resolver = resolve(self.url)
