        ...
        expected = [
            {
                ...
                "is_users_profile_complete": self.challenge.is_users_profile_complete,
            }
        ]
        ...
        expected = [
            {
                ...
                "is_users_profile_complete": self.challenge3.is_users_profile_complete,
            }
        ]
        ...
        expected = [
            {
                ...
                "is_users_profile_complete": self.challenge2.is_users_profile_complete,
            }
        ]
        response = self.client.get(self.url, {}, format="json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        ...
        expected = [
            {
                ...
                "is_users_profile_complete": self.challenge4.is_users_profile_complete,
            }
        ]
        response = self.client.get(self.url, {}, format="json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
