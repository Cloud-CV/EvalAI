...
class WorkerUtilTestClass(BaseTestClass):
    ...
    def test_return_url_per_environment(self):
        returned_url = interface.return_url_per_environment(self.test_url)
    ...
    def test_make_request_connection_error(self, mock_logger):
        ...
        with self.assertRaises(requests.exceptions.RequestError):
            interface.make_request(url, "GET")
    ...
    # TO-DO: Add test for delete_message_from_sqs_queue
