...
2. **Create a starter example**:
    ...
    1. *Create a starter example scrip*_: Please create a starter agent submission and a local evaluation script in order to help the participants perform sanity checks on their code before making submissions to EvalAI.
