...
- **challenge_phase_splits**:
  ...
  - **leaderboard_order_is_descending**: True/False (a Boolean field that gives the flexibility to challenge host for changing the default leaderboard sorting order. Default is `True`)
