...
Some of the popular challenges that we have hosted are shown below:
...
1. **Prediction upload based challenges**: Participants upload predictions corresponding to ground truth labels in the form of a file (could be any format: `json`, `npy`, `csv`, `txt` etc). If you are interested in hosting prediction upload based challenges, then [click here](/host_challenge.html#host-a-prediction-upload-based-challenge).

2. **Code upload based challenges**: In these kind of challenges, participants upload their training code in the form of docker images using [EvalAI-CLI]. If you are interested in hosting code upload based challenges, then [click here](/host_challenge.html#host-a-prediction-upload-based-challenge).

## Host a Prediction upload based challenge
...
TODO: Add steps to create a code upload based challenge
